...
final class RMEpisodeInfoCVCell: UICollectionViewCell {
    static let cellIdentifier = "RMEpisodeInfoCVCell"
    ...
    func configure(with viewModel: RMEpisodeInfoCVCellVM) {
